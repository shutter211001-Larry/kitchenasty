...
export default function ModernHeader() {const { t, user, logout, isLoading, itemCount, openCart, settings, navLinks, isActive, mobileOpen, setMobileOpen, headerRef , recentOrders } = useHeaderProps();return (
