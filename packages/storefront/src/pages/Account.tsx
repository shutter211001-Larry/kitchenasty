              ...
              <div className="space-y-6">
                ...
                {(user as any).hasPassword ? (
                  ...
                  <div className="p-4 bg-surface-soft rounded-xl border border-dashed border-input">
                    <p className="text-sm text-sub">{t('account.passwordNotSetWarning')}</p>
                    <button
      ...
      <div className="p-8 border-b border-input">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-surface-soft/30 border border-input rounded-2xl">
            <div>
              <h3 className="font-bold text-main">{t('account.emailNotifications')}</h3>
              <p className="text-xs text-sub mt-1">{t('account.receiveOrderEmails')}</p>
            </div>
            <button
              onClick={async () => {
          ...
          <div className="flex items-center justify-between p-4 bg-surface-soft/30 border border-input rounded-2xl">
            <div>
              <h3 className="font-bold text-main">{t('account.lineNotifications')}</h3>
              <p className="text-xs text-sub mt-1">{t('account.receiveLineNotifications')}</p>
              {!user.lineUserId && <p className="text-[10px] text-amber-600 mt-1">{t('account.bindLineAccountFirst')}</p>}
            </div>
            <button
          ...
          <div className="flex items-center justify-between p-5 bg-surface-soft/30 border border-input rounded-2xl">
            <div>
              ...
              <p className="text-xs text-sub mt-1">
                {(user as any).hasPassword ? '••••••••' : t('account.passwordNotYetSet')}
              </p>
            </div>
            <button
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-sub font-medium">
                    {user.lineUserId
                      ? user.lineDisplayName || t('account.authorizedUser')
                      : t('account.linkForNotifications')}
                  </p>
                </div>
              </div>
            ...
            <div className={`flex flex-col sm:flex-row sm:items-center justify-between gap-6 p-6 rounded-2xl border-2 transition-all hover:shadow-md ${(user as any).googleId ? 'border-blue-200 dark:border-blue-800 bg-blue-50/[0.03]' : 'border-input bg-surface-soft/30'}`}>
              <div className="flex items-center gap-5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-sub font-medium">
                    {(user as any).googleId
                      ? (user as any).googleEmail || t('account.googleAccount')
                      : t('account.linkGoogleForLogin')}
                  </p>
                </div>
              </div>
