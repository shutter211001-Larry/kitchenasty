...
1. Navigate to **Staff > Invite Staff** in the admin panel
2. Enter the invitee's email, optional name, and desired role
...
- **Revocable** — stored in the database as queryable records
...
- **Edit** link to update staff details
...
- **Route guards** — `RequireRole` component redirects unauthorized users to the dashboard
