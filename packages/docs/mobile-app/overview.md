...
- Your KitchenAsty server running and accessible via HTTPS (see [Self-Hosting Guide](/self-hosting/overview))
...
2. **[App Configuration](/mobile-app/app-configuration)** — Customize the app with your branding, API URL, and keys
3. **[Local Development](/mobile-app/local-development)** — Run the app locally for testing
4. **[EAS Build Setup](/mobile-app/eas-build)** — Configure Expo Application Services for cloud builds
