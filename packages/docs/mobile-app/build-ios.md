...
## Step 1: Create Your App on App Store Connect

1. Log in to [App Store Connect](https://appstoreconnect.apple.com)
2. Click **"My Apps"** → the **"+"** button → **"New App"**
3. Fill in the details:
   - **Platforms**: iOS
   - **Name**: Your restaurant name (e.g., "Mario's Pizza") — this must be unique on the App Store
   ...
   - **SKU**: A unique identifier you choose (e.g., `mariospizza-ios-1`)
...
3. Build the app on Expo's Mac build servers
...
- [Screenshots.pro](https://screenshots.pro) — drag-and-drop screenshot designer
...
- **Missing backend**: Server is down or unreachable during review
- **Placeholder content**: Using "Lorem ipsum" or stock images
- **Guideline 4.2**: If the app is too simple (a "web wrapper"), Apple may reject it. KitchenAsty is a full native app, so this shouldn't be an issue.
...
1. **Manual release**: You click "Release" when ready
