...
## Step 1: Create Your App on Google Play Console

1. Log in to [Google Play Console](https://play.google.com/console)
2. Click **"Create app"**
3. Fill in the details:
   - **App name**: Your restaurant name (e.g., "Mario's Pizza")
...
| Feature graphic | 1024 x 500 px | Banner shown at the top of your listing |
