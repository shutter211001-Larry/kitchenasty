...
- [Menu Management](/features/menu-management) — Categories, options, allergens, and mealtimes
- [Configuration](/configuration/environment-variables) — Customize payment providers, email, and more
