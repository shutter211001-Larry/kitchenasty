...
- Firewall rules protecting your server
...
| [AWS Lightsail](https://aws.amazon.com/lightsail) | 2 GB instance | $10/month | AWS ecosystem |
...
1. **[Server Setup](/self-hosting/server-setup)** — Provision a server, install Docker, and configure the firewall
