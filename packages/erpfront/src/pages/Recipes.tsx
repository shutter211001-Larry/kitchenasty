                ...
                <p className="text-xs text-muted-foreground mt-1">
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-lg font-black text-gray-800 truncate max-w-[160px]">
                        {r.name}
                      </h3>
                    ...
                    <p className="text-xs text-muted-foreground line-clamp-2 mb-4 h-8">
                      {r.description || i18n.t("erp_767")}
                    </p>

                    <div className="grid grid-cols-2 gap-4 border-t border-border pt-4">
                      <div>
                        <p className="text-[9px] uppercase font-black text-muted-foreground tracking-wider mb-0.5">
                          {t("erp_768")}
                        </p>
