    ...
    <div className="flex flex-col gap-8">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">{t("erp_343")}</p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground mt-0.5">
                      {shortageCount > 0 ? t("erp_364") : t("erp_365")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-border shadow-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-7 gap-4 items-center">
                  ...
                  <div className="bg-orange-50/40 border border-orange-100 p-5 rounded-2xl flex flex-col items-center text-center shadow-sm hover:scale-105 transition-all duration-300">
                    ...
                    <span className="text-xs text-orange-800 font-extrabold uppercase tracking-wider mb-1">
                      R&D Recipe
                    </span>
                  ...
                  <div className="bg-blue-50/40 border border-blue-100 p-5 rounded-2xl flex flex-col items-center text-center shadow-sm hover:scale-105 transition-all duration-300">
                    ...
                    <span className="text-xs text-blue-800 font-extrabold uppercase tracking-wider mb-1">
                      Central Kitchen
                    </span>
                    <h4 className="text-sm font-bold text-gray-800">
                      {t("erp_370")}
                  ...
                  <div className="bg-emerald-50/40 border border-emerald-100 p-5 rounded-2xl flex flex-col items-center text-center shadow-sm hover:scale-105 transition-all duration-300">
                    ...
                    <span className="text-xs text-emerald-800 font-extrabold uppercase tracking-wider mb-1">
                      Store Reservation
                    </span>
                    <h4 className="text-sm font-bold text-gray-800">
                      {t("erp_372")}
                  ...
                  <div className="bg-purple-50/40 border border-purple-100 p-5 rounded-2xl flex flex-col items-center text-center shadow-sm hover:scale-105 transition-all duration-300">
                    ...
                    <span className="text-xs text-purple-800 font-extrabold uppercase tracking-wider mb-1">
                      Online Ordering
                    </span>
                    <h4 className="text-sm font-bold text-gray-800">
                      {t("erp_375")}
                        ...
                        <div>
                          <div className="flex justify-between items-start mb-3">
                            <span className="px-2 py-0.5 bg-gray-100 rounded-md text-[10px] font-bold text-gray-600">
                              {item.category?.name || i18n.t("erp_379")}
                            </span>
                          ...
                          {bound ? (
                            <div className="mt-4 p-3 bg-emerald-50 border border-emerald-100 rounded-xl flex items-center justify-between">
                              <div className="min-w-0">
                                ...
                                <span className="text-sm font-semibold text-emerald-800 truncate block mt-0.5">
                                  {bound.recipeName}
                                </span>
                              </div>
                              <button
                    ...
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b border-border text-xs text-muted-foreground uppercase tracking-wider font-extrabold">
                          <th className="pb-3 text-gray-600">{t("erp_395")}</th>
                          <th className="pb-3 text-gray-600">{t("erp_396")}</th>
                          <th className="pb-3 text-gray-600">{t("erp_397")}</th>
                          <th className="pb-3 text-gray-600">{t("erp_398")}</th>
                          <th className="pb-3 text-gray-600 text-right">
                            {t("erp_399")}
                          </th>
                        </tr>
                      </thead>
                        ...
                        {forecastedIngredients.map((ing) => (
                          ...
                          >
                            ...
                            <td className="py-4 text-gray-700 font-semibold">
                              {ing.predictedDemand.toFixed(1)} {ing.unit}
                            </td>
                            <td className="py-4 text-gray-700 font-semibold">
                ...
                {deductionLogs.length === 0 ? (
                  ...
                  <div className="overflow-x-auto max-h-[500px] overflow-y-auto">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b border-border text-xs text-muted-foreground uppercase tracking-wider font-extrabold">
                          <th className="pb-3 text-gray-600">{t("erp_410")}</th>
                          <th className="pb-3 text-gray-600">{t("erp_411")}</th>
                          <th className="pb-3 text-gray-600">{t("erp_412")}</th>
                          <th className="pb-3 text-gray-600 text-right">
                            {t("erp_413")}
                          </th>
                        </tr>
