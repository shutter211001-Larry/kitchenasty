...
ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "isFranchise" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "franchiseeName" TEXT;
